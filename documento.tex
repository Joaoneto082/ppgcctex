...
% 	\imprimirfichacatalografica{1-pre-textuais/ficha-catalografica} %  gerada pela biblioteca 
	...
	%Elementos textuais
	\textual
	\input{2-textuais/1-justificativa}
	\input{2-textuais/2-introducao}
	\input{2-textuais/3-hipotese-objetivos}
	\input{2-textuais/4-revisao-sistematica}
	\input{2-textuais/3-fundamentacao-teorica}
	\input{2-textuais/6-trabalhos-relacionados}
	\input{2-textuais/5-materiais-metodos}
	\input{2-textuais/7-implementacao}
	\input{2-textuais/8-resultados}
	\input{2-textuais/9-validacao-tam}
	\input{2-textuais/9-discussao}
	\input{2-textuais/10-conclusao}
	
	%Elementos pós-textuais
	\bibliography{3-pos-textuais/referencias}
	\imprimirapendices
	\input{3-pos-textuais/apendices/apendice-tam}
	\input{3-pos-textuais/apendices/apendice-config}
%	\imprimirglossario	
%	\imprimirindice
