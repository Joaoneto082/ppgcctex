...
A etapa de avaliação do artefato, prevista no ciclo da Design Science, foi operacionalizada por meio do \textit{Technology Acceptance Model} (TAM), proposto por \citeonline{davis1989}. O TAM é um dos modelos mais consolidados da literatura de Sistemas de Informação para explicar a aceitação de tecnologias por seus usuários, postulando que a adoção de um sistema é determinada principalmente por dois construtos: a \textbf{Percepção de Utilidade} (PU), definida como o grau em que uma pessoa acredita que o uso do sistema melhorará seu desempenho, e a \textbf{Percepção de Facilidade de Uso} (PFU), definida como o grau em que uma pessoa acredita que o uso do sistema será livre de esforço \cite{davis1989}. Extensões posteriores do modelo incorporaram a \textbf{Intenção Comportamental de Uso} (ICU) como construto mediador entre as percepções e o uso efetivo da tecnologia \cite{venkatesh2000}.
