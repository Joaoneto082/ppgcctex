...
Convém reforçar que apenas os ODS 9 e 16 em Mossoró-RN foram efetivamente validados e dispõem de dados em volume suficiente para análise; todos os demais cenários relatados nesta seção têm finalidade exclusiva de demonstrar a capacidade de generalização da abordagem, e não devem ser lidos como diagnósticos consolidados.
