...
\begin{itemize}
    \item \textbf{Eixo temático}: estender a abordagem, de forma validada e com coleta em escala, aos demais objetivos da Agenda 2030, a partir das execuções exploratórias já realizadas para os ODS 3 e 4, rumo a um diagnóstico municipal abrangente que contemple os 17 ODS;
    ...
    \item \textbf{Eixo de melhorias metodológicas}: investigar técnicas avançadas de \textit{prompt engineering} (cadeia de pensamento, \textit{few-shot learning}), estratégias de amostragem que mitiguem o viés de confirmação dos termos de busca, e modelagem estatística para quantificar as relações causais entre as dimensões dos ODS identificadas qualitativamente nesta pesquisa;
