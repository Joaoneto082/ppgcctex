...
\begin{itemize}
    ...
    \item \textbf{Análise multi-cidade e multi-ODS validada}: converter as execuções exploratórias já realizadas em outras capitais (ODS 9 e 16) e em outros objetivos (ODS 3 e 4) em estudos validados, com coleta em escala e confronto com indicadores locais, comparando os padrões identificados em Mossoró com os de outros municípios e domínios temáticos para identificar problemas comuns e boas práticas replicáveis;
