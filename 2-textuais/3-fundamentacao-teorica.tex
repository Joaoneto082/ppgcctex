...
limitações de granularidade espacial e temporal, características que esta dissertação
busca complementar.
...
de inovação que apoiem o empreendedorismo local. Mossoró-RN apresenta pontuação baixa nesse objetivo.
...
médio satisfatório enquanto bairros ou setores específicos enfrentam privações.
...
vinculam relatos textuais espontâneos a estabelecimentos físicos concretos como terminais
rodoviários, unidades de saúde, escolas, órgãos públicos, espaços urbanos. Essa ancoragem
geoespacial possibilita diagnósticos em nível de estabelecimento e permite identificar \emph{onde} e \emph{por que} os
problemas se manifestam.

A abordagem perceptiva complementa os indicadores oficiais. Enquanto
...
contextos onde dados rotulados são escassos, especialmente quando não é possível um treinamento adicional \cite{agua2025,larosa2025}.
