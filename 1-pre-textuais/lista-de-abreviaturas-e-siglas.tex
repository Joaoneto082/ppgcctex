\newacronym{ABSA}{ABSA}{\textit{Aspect-Based Sentiment Analysis}}
...
\newacronym{ICU}{ICU}{Intenção Comportamental de Uso}
...
\newacronym{PU}{PU}{Percepção de Utilidade}
...
\newacronym{TAM}{TAM}{\textit{Technology Acceptance Model}}
\newacronym{VADER}{VADER}{\textit{Valence Aware Dictionary and sEntiment Reasoner}}
